...
public class TourismSpotAdapter extends BaseAdapter {
	...
	public TourismSpotAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		deskripsi.setText(daftar_berita.get(ListTourismSpot.TAG_INFO));
		nama.setText(daftar_berita.get(ListTourismSpot.TAG_NAMA));
		harga.setText(daftar_berita.get(ListTourismSpot.TAG_ALAMAT));
		//fasilitas.setText(daftar_berita.get(listvilla.TAG_FAL));
		id.setText(daftar_berita.get(ListTourismSpot.TAG_IDSPOT));
